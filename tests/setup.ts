...
if (typeof globalThis.window === 'undefined' || typeof globalThis.document === 'undefined') {
  ...
  try {
    Object.defineProperty(globalThis, 'fetch', { value: mockFetch, writable: false, configurable: false })
  } catch (_err) {
  ...
  try {
    // @ts-ignore
    Object.defineProperty(globalThis.window, 'fetch', { value: mockFetch, writable: false, configurable: false })
  } catch (_err) {
    void _err
    // @ts-ignore
  ...
  globalThis.window.requestAnimationFrame = function (cb: any) { return setTimeout(cb, 0) }
