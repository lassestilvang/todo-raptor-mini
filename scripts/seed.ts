...
;(async () => {
  ...
  await createTask({ title: 'Welcome to Todo Raptor', notes: 'This is your inbox task. Edit or delete it.', listId: inbox.id })
  await createTask({ title: 'Plan project', notes: 'Create milestones and schedule user interviews.', listId: work.id })

  console.log('Seeded sample lists and tasks (in-memory). To persist, run a similar script against your DB file.')
})()
